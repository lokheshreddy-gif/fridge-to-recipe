...
export default function ServingsControl({ servings, baseServings, onServingsChange }) {
  ...
  return (
    <div className="glass-card rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-center justify-between gap-4 border border-slate-700/60 shadow-lg">
      ...
      <div className="flex items-center gap-3 w-full sm:w-auto justify-between sm:justify-end">
        ...
        <div className="relative min-w-16 h-10 bg-slate-900/90 border border-slate-700/80 rounded-xl flex items-center justify-center overflow-hidden font-extrabold text-lg text-indigo-300 px-3">
