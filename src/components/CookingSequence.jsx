          ...
          {!isFinished ? (
            ...
            >
              ...
              {currentStep.durationMinutes && (
                <div className="bg-white dark:bg-slate-900 text-slate-900 dark:text-slate-100 p-4 rounded-2xl border border-slate-300 dark:border-slate-800 flex items-center justify-between gap-4 w-full max-w-sm shadow-md">
                  <div className="flex items-center gap-3">
                    <div className="relative w-12 h-12 flex items-center justify-center">
                      ...
                      <Clock className="w-5 h-5 text-indigo-500 dark:text-indigo-400 absolute" />
                    </div>

                    <div className="text-left">
                      <span className="text-xs text-slate-700 dark:text-slate-300 font-semibold block">Timer</span>
            ...
            >
              <div className="w-20 h-20 rounded-3xl bg-emerald-500/20 border border-emerald-500/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center mx-auto shadow-xl">
